...
class System:
    ...
    def init_workshop(self):
        ...
        self.workshops.append(Workshop("Mine", {"x": 100, "y": 400},3))
        self.workshops.append(Workshop("Ore Processing", {"x": 350, "y": 350},4))
        self.workshops.append(Workshop("Loading Dock", {"x": 600, "y": 350},5))

    def init_transit(self):
        # Assumed that container capacity is 10.000L. No indication anywhere.
        self.transits.append(Transit("Tank", self.workshops[1], self.workshops[3], "Chemical mix", 10000, 0, 'L'))
        ...
        self.transits.append(Transit("Pit 1", self.workshops[2], self.workshops[3], "Ore", 200, 0, 'T'))
        ...
        self.transits.append(Transit("Pit 2", self.workshops[3], self.workshops[4], "Iron", 200, 0, 'T'))
        self.workshops[3].addOutEdge(self.transits[2])
        self.workshops[4].addInEdge(self.transits[2])

        self.transits.append(Transit("Transit", self.workshops[0], self.workshops[1], "", 300000,10000, 'L'))
